...
export function No1({navigation}: any) {
  ...
  return (
    <QuestionPageBasicLayout
      ...
      children={undefined}
      pageNumber={1}></QuestionPageBasicLayout>
  );
}
...
export function No2({navigation}: any) {
  ...
  return (
    <QuestionPageBasicLayout
      ...
      children={undefined}
      globalLogics={highestContext}
      pageNumber={2}></QuestionPageBasicLayout>
  );
}
  ...
  return (
    <ScrollView>
      <QuestionPageBasicLayout
        ...
        children={undefined}
        globalLogics={highestContext}
        pageNumber={3}></QuestionPageBasicLayout>
    </ScrollView>
  );
}
  ...
  return (
    <ScrollView>
      <QuestionPageBasicLayout
        ...
        children={undefined}
        globalLogics={highestContext}
        pageNumber={4}></QuestionPageBasicLayout>
    </ScrollView>
  );
}
  ...
  return (
    <ScrollView>
      <QuestionPageBasicLayout
        ...
        children={undefined}
        globalLogics={highestContext}
        pageNumber={5}></QuestionPageBasicLayout>
    </ScrollView>
  );
}
  ...
  return (
    <ScrollView>
      <QuestionPageBasicLayout
        ...
        children={undefined}
        globalLogics={highestContext}
        pageNumber={6}></QuestionPageBasicLayout>
    </ScrollView>
  );
}
  ...
  return (
    <ScrollView>
      <QuestionPageBasicLayout
        ...
        children={undefined}
        globalLogics={highestContext}
        pageNumber={7}></QuestionPageBasicLayout>
    </ScrollView>
  );
}
  ...
  return (
    <ScrollView>
      <QuestionPageBasicLayout
        ...
        children={undefined}
        globalLogics={highestContext}
        pageNumber={8}></QuestionPageBasicLayout>
    </ScrollView>
  );
}
  ...
  return (
    <ScrollView>
      <QuestionPageBasicLayout
        ...
        children={undefined}
        globalLogics={highestContext}
        pageNumber={9}></QuestionPageBasicLayout>
    </ScrollView>
  );
}
